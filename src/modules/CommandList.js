...
Commands.list = {
    help: function (gameServer, split) {
        ...
        console.log("minion [id] [amount] [name]  : dank minions made by BHax.org");
        console.log("====================================================");
    },
      ...
      for (var i in gameServer.clients) {
        if (gameServer.clients[i].playerTracker.pID == id) {
          var client = gameServer.clients[i].playerTracker;
            ...
            for (var i = 0; i < add; i++) {
              gameServer.bots.addMBot(client, name);
            }
            console.log("[Console] Succesfully added " + add + " minions for " + client.getFriendlyName());
            break;
          }
      }
    },
